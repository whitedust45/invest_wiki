...
VALUATION_JSON = ROOT / "apps" / "dashboard" / "data" / "ic-im-valuation.json"
LEDGER_DB = ROOT / "apps" / "dashboard" / "data" / "ledger.db"
...
def main(argv: list[str]) -> int:
    ...
    print(f"Serving dashboard on http://{args.host}:{args.port}/apps/dashboard/index.html")
    try:
