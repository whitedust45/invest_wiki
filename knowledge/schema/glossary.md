...
### asset-cushion — 存量资产垫 / Asset Cushion

**同义词**：资产垫、存量资产垫、清算资产垫、净可变现资产垫、Asset Cushion

**定义**：用当前可变现资产扣除真实负债后的价值衡量烟蒂股的静态安全边际

**相关页**：[[asset-cushion]]（已建）

### positive-cash-inflow — 正现金流入 / Positive Cash Inflow

**同义词**：正现金流入、现金净流入、真实正现金流、Positive Cash Inflow

**定义**：确认企业不会在等待资产兑现期间继续消耗已有资产垫的现金流过滤器

**相关页**：[[positive-cash-inflow]]（已建）
...
### cigar-butt-investing — 烟蒂投资 / Cigar-butt Investing

**同义词**：烟蒂股、烟蒂策略、静态价值型烟蒂、格雷厄姆烟蒂、Cigar-butt Investing、Net-net

**定义**：寻找市场价格显著低于可确认资产价值的低估证券，并依赖资产垫和兑现路径获得回报

**相关页**：[[cigar-butt-investing]]（已建）
