...
可复用脚本位于：[`scripts/ic_im_roll_discount_stress.py`](../../scripts/ic_im_roll_discount_stress.py)

脚本会默认读取 [`wiki/portfolios/personal-position-sizing-framework.md`](../../wiki/portfolios/personal-position-sizing-framework.md) 里的个人阈值配置。
...
```bash
python3 scripts/ic_im_roll_discount_stress.py
```
...
```bash
python3 scripts/ic_im_roll_discount_stress.py --interactive
```
