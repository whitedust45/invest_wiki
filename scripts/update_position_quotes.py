...
DASHBOARD_JSON = Path("hybrid-barbell-dashboard/data/position-quotes.json")
POSITION_HISTORY_JSON = Path("hybrid-barbell-dashboard/data/position-history.json")
...
def main(argv: list[str]) -> int:
    ...
    if not args.symbols:
        print("missing symbols, e.g. scripts/update_position_quotes.py 000568 000858", file=sys.stderr)
        return 2
